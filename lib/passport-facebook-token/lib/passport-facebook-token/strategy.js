...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
  ...
  var pn = req.body.pn;
  var androidToken = req.body.androidToken;
  var iosToken = req.body.iosToken;
  var appVersion = req.body.appVersion;
  var fbToken = req.body.fbToken || accessToken;
  ...
  self._loadUserProfile(fbToken, function(err, profile) {
    ...
    if (self._passReqToCallback) {
      self._verify(req, fbToken, refreshToken, profile, pn, iosToken, androidToken, verified);
    } else {
      self._verify(fbToken, refreshToken, profile, pn, iosToken, androidToken, verified);
    }
  });
}
