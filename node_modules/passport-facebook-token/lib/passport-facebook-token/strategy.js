...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
 ...
 function getToken() {
  ...
  var iosToken = req.body.iosToken || req.query.iosToken;
  ...
  self._loadUserProfile(accessToken, function(err, profile) {
    ...
    if (self._passReqToCallback) {
      self._verify(req, accessToken, refreshToken, profile, pn, iosToken, verified);
    } else {
      self._verify(accessToken, refreshToken, profile, pn, iosToken, verified);
    }
  });
}
