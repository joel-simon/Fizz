...
FacebookTokenStrategy.prototype.authenticate = function(req, options) {
 ...
 function getToken() {
    ...
    //
    if (req.body.fbToken) return req.body.fbToken;
    if (req.query.fbToken) return req.query.fbToken;
  ...
  var pn = req.body.pn || req.query.pn;
  var iosToken = req.body.iosToken || req.query.iosToken || null;
  var androidToken = req.body.androidToken || null;

  // console.log(req.body, req.query);
  var refreshToken = req.body.refresh_token || req.query.refresh_token;
  // console.log('accessToken:'+!!accessToken);
  self._loadUserProfile(accessToken, function(err, profile) {
    if (err) { console.log(err);return self.fail(err); };
    ...
    if (self._passReqToCallback) {
      self._verify(req, accessToken, refreshToken, profile, pn, iosToken, androidToken, verified);
    } else {
      self._verify(accessToken, refreshToken, profile, pn, iosToken, androidToken, verified);
    }
  });
}
