...
exports.addMessage = (eid, uid, text, callback) ->
  ...
  q2 = 'INSERT INTO messages (eid, uid, text, "creationTime") VALUES ($1, $2, $3, $4) returning *'
  db.query q2, [eid, uid, text, Date.now()], (err, result) ->
    return callback err if err?
    return callback null, result.rows[0]

exports.getMoreMessages = (eid, mid, cb) ->
  q1 = 'SELECT * FROM messages WHERE eid = $1 and mid >= $2 ORDER BY "creationTime" LIMIT 10'
